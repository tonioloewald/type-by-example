...
test ('instance types', () => {
  ...
  expect(matchTypeString('#instance Date', new Date())).toBe('')
  expect(matchTypeString('#instance Date', 'blah')).toBe('was \"blah\", expected #instance Date')
  expect(matchTypeString('#instance Date', new Foo())).toBe('was Foo, expected #instance Date')
})
